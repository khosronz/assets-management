...
return array(
    ...
    'admin_cc_email'            => 'پست الکترونیکی CC',
    'admin_cc_email_help'       => 'اگر می‌خواهید یک کپی از ایمیل‌های checkin / checkout را ارسال کنید که به کاربران ارسال می‌شوند تا حساب دیگری برای ایمیل ارسال کنید، در اینجا وارد کنید . در غیر این صورت ، این میدان را خالی بگذارید .',
    ...
    'custom_forgot_pass_url'	=> 'تنظیم نشانی اینترنتی گذرواژه سفارشی',
    'custom_forgot_pass_url_help'	=> 'این کار جایگزین نشانی اینترنتی رمز عبور built شده بر روی صفحه ورود به سیستم می‌شود ، که برای هدایت افراد مستقیم به قابلیت راه‌اندازی مجدد گذرواژه LDAP داخلی یا میزبان مفید است . به طور موثر قابلیت عبور کاربر محلی را غیرفعال می‌کند .',
    'dashboard_message'			=> 'پیغام داشبورد',
    'dashboard_message_help'	=> 'این متن بر روی داشبورد برای هر کسی که اجازه مشاهده داشبورد را دارد ، ظاهر خواهد شد .',
...
',
    ...
    'login_remote_user_text'    => 'گزینه‌های ورود به سیستم از راه دور',
    'login_remote_user_enabled_text' => 'فعال کردن ورود به سیستم با عنوان کاربر از راه دور',
    'login_remote_user_enabled_help' => 'این گزینه امکان تأیید اعتبار را از طریق هدر REMOTE_USER با توجه به "رابط دروازه مشترک (rfc3875)"',
    'login_common_disabled_text' => 'از کار انداختن سایر سازوکارهای تایید هویت',
    'login_common_disabled_help' => 'این گزینه سایر مکانیسم های تأیید اعتبار را غیرفعال می کند. اگر مطمئن هستید که ورود REMOTE_USER شما در حال کار است ، فقط این گزینه را فعال کنید',
    'login_remote_user_custom_logout_url_text' => 'نشانی اینترنتی سفارشی خروج از سیستم',
    'login_remote_user_custom_logout_url_help' => 'اگر آدرس اینترنتی در اینجا ارائه شود ، کاربران پس از اینکه کاربر از سامانه خارج شد ، به این نشانی اینترنتی هدایت می شوند. این برای بستن صحیح جلسات کاربر ارائه دهنده تأیید اعتبار شما مفید است.',
    'logo'                    	=> 'لوگو',
    'logo_print_assets'         => 'استفاده در چاپ',
    'logo_print_assets_help'    => 'استفاده از علامت‌گذاری در فهرست اموال قابل چاپ ',
    ...
    'show_in_model_list'   => 'نمایش در مدل Dropdowns',
    'optional'					=> 'اختیاری',
    ...
    'setting'                   => 'تنظیمات',
    'settings'                  => 'تنظيمات',
    'show_alerts_in_menu'       => 'نشان دادن هشدارها در منوی بالا',
    'show_archived_in_list'     => 'دارایی بایگانی شده',
    'show_archived_in_list_text'     => 'نشان دادن دارایی‌های بایگانی شده در فهرست " همه دارایی‌ها "',
    'show_images_in_email'     => 'نمایش تصاویر در ایمیل‌ها',
    'show_images_in_email_help'   => 'اگر نصب سامانه پشت یک VPN یا شبکه بسته باشد و کاربران خارج از شبکه قادر به بار کردن تصاویر این نصب در ایمیل‌های خود نباشند ، تیک این جعبه را بردارید .',
    'site_name'                 => 'نام سایت',
    ...
    'slack_integration_help_button'    => 'زمانی که اطلاعات اسلاک را ذخیره کردید ، یک دکمه تست به دست خواهد آمد .',
    'slack_test_help'           => 'آزمایش اینکه آیا ادغام اسلاک درست پیکربندی شده‌است یا نه . شما باید اول تنظیمات slack ذخیره شده خود را دخیره کنید.',
    'snipe_version'  			=> 'نسخه سامانه',
    'support_footer'            => 'پشتیبانی از پیوندهای پاصفحه ',
    'support_footer_help'       => 'مشخص کنید که چه کسی لینک‌های مربوط به اطلاعات پشتیبانی IT و راهنمای کاربران را مشاهده می‌کند .',
    'version_footer'            => 'نسخه در پاصفحه ',
    'version_footer_help'       => 'مشخص کنید که چه کسی نسخه سامانه را می‌بیند و شماره را می‌سازد .',
    ...
    'privacy_policy_link'       => 'پیوند با سیاست حریم خصوصی',
    'privacy_policy'            => 'سیاست حفظ حریم خصوصی',
    'privacy_policy_link_help'  => 'اگر یک نشانی اینترنتی در اینجا گنجانده شود ، یک لینک به سیاست حریم خصوصی شما در پاصفحه چاپ خواهد شد و در هر نوع ایمیل که سیستم در انطباق با GDPR ارسال می‌کند .',
    ...
    'width_w'        => 'عرض',
    'height_h'        => 'ارتفاع',
    'show_url_in_emails'                => 'پیوند به سامانه در ایمیل',
    'show_url_in_emails_help_text'      => 'اگر نمیخواهید پیوند به نصب سامانه خود را در زیرپوشهای ایمیل خود پیگیری کنید، این کادر را بردارید. مفید است اگر اکثر کاربران شما هرگز وارد نشده باشند.',
    'text_pt'        => 'بالای صفحه',
    ...
    'unique_serial_help_text'                => 'بررسی این جعبه یک محدودیت منحصر به فردی بر روی سریال‌های دارایی به اجرا در خواهد آورد .',
    'zerofill_count'        => 'طول برچسب دارایی، از جمله صفر',
    'Logo, Site Name'       => 'برند ، نام سایت',
    'Default EULA and more'       => 'پیش فرض EULA و موارد دیگر',
    'Security'       => 'امنیت',
    'Two-factor, Password Restrictions'       => 'محدودیت های دو عاملی ، گذرواژه',
    'Groups'       => 'گروه ها',
    'Account permission groups'       => 'گروه های مجوز حساب',
    'Localization'       => 'بومی سازی',
    'Language, date display'       => 'زبان ، نمایش تاریخ',
    'Notifications'       => 'اطلاعیه ها',
    'Email alerts'       => 'هشدارهای ایمیل',
    'Slack'       => 'اسلاک',
    'Slack settings'       => 'تنظیمات اسلاک',
    'Asset Tags'       => 'برچسب‌ها در دارایی',
    'Incrementing and prefixes'       => 'در حال افزایش و پیشوندها',
    'Barcodes'       => 'بارکد',
    'Barcode & QR settings'       => 'تنظیمات بارکد و QR',
    'Labels'       => 'برچسب ها',
    'Label sizes & settings'       => 'اندازه و تنظیمات برچسب',
    'LDAP'       => 'LDAP',
    'LDAP/Active Directory'       => 'LDAP/اکتیو دایرکتوری',
    'Backups'       => 'بک آپ',
    'Download files & Data'       => 'بارگیری فایل ها و داده ها',
    'OAuth'       => 'OAuth',
    'Oauth Endpoint Settings'       => 'Oauth Endpoint Settings',
    'PHP'       => 'پی اچ پی',
    'PHP System Info'       => 'اطلاعات سیستم پی اچ پی',
    'Purge'       => 'پاک‌سازی',
    'Purge Deleted Records'       => 'پاک‌سازی رکوردها',
    'Default Blue'       => 'آبی پیش‌فرض',
    'Green Dark'       => 'تاریکی سبز',
    'Red Dark'       => 'قرمز تیره',
    'Orange Dark'       => 'سیاه نارنجی',
    'Update Branding Settings'       => 'به‌هنگام‌سازی سیستم نام تجاری',
    'Update General Settings'       => 'به‌هنگام‌سازی تنظیمات عمومی',
    'Update_Alert_Settings'       => 'به‌هنگام‌سازی تنظیمات اعلان هشدار',
    'alerts'       => 'اعلام هشدارها',
    'Security'       => 'امنیت',
    'Update_Security_Settings'       => 'به‌هنگام‌سازی تنظیمات امنیتی',
    'Update_Localization_Settings'       => 'به روز رسانی تنظیمات بومی سازی',
    'Localization'       => 'بومی سازی',
    'Update_Slack_Settings'       => 'به‌هنگام‌سازی تنظیمات اسلاک',
    'Slack'       => 'اسلاک',
    'Update_Asset_Tag_Settings'       => 'به‌هنگام‌سازی برچسب دارایی',
    'Asset_Tags'       => 'برچسب‌های دارایی',
    'Update_Barcode_Settings'       => 'به‌هنگام‌سازی تنظیمات بارکد',
    'Barcodes'       => 'بارکد',
    'Update_Label_Settings'       => 'به‌هنگام‌سازی تنظیمات برچسب',
    'Labels'       => 'برچسب',
    'Update_LDAP/AD_Settings'       => 'به‌هنگام‌سازی تنظیمات LDAP / AD',
    'Backup_files_are_located_in'       => 'پرونده‌های پشتیبان در آن قرار دارند',
    'Purge_Deleted'       => 'پاک‌سازی پایگاه‌داده',
    'PHP_Info'       => 'اطلاعات پی اچ پی',
    'Remove'       => 'پاک کردن',
    'Require_at_least_one_letter'       => 'ملزم کردن حداقل یک حرف',
    'Require_at_least_one_number'       => 'ملزم کردن حداقل یک حرف',
    'Require_at_least_one_symbol'       => 'به حداقل یک نماد نیاز داشته باشد',
    'Require_at_least_one_uppercase_and_one_lowercase'       => 'نیاز به حداقل یک حرف بزرگ و یک حرف کوچک',
    'Email addresses or distribution lists you want alerts to be sent to, comma separated'       => 'آدرس‌های پست الکترونیکی و یا لیست‌های توزیع که می‌خواهید برای ارسال به آن‌ها ارسال شود ، کاما از هم جدا کنید .',
