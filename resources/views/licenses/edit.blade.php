...
<div class="form-group {{ $errors->has('termination_date') ? ' has-error' : '' }}">
    ...
    <div class="input-group col-md-3">
        {{--<div class="input-group date" data-provide="datepicker" data-date-format="yyyy-mm-dd"  data-autoclose="true">--}}
        <div class="input-group date" data-date-format="yyyy-mm-dd"  data-autoclose="true">
            <input type="text" class="form-control" placeholder="{{ trans('general.select_date') }}" name="termination_date" id="termination_date_persian" value="{{ Input::old('termination_date', jdate($item->termination_date)) }}">
            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
        </div>
...
<script type="text/javascript">
    $("#termination_date_persian").persianDatepicker({
        months: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند"],
        dowTitle: ["شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه", "جمعه"],
        shortDowTitle: ["ش", "ی", "د", "س", "چ", "پ", "ج"],
        showGregorianDate: !1,
